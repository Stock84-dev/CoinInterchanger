...
namespace CoinInterchanger.UI.Controls.Forms
{
	...
	public partial class FormBase : Form
	{
		...
		public FormBase()
		{
			...
			foreach (var control in new Control[] { formIcon, minimizeLabel, maximizeLabel, closeLabel })
			{
			...
			formIcon.MouseDown += SystemLabel_MouseDown;
			formIcon.MouseUp += SystemLabel_MouseUp;
			...
			//header1.AddControlToHeader(minimizeLabel, 0);
			//header1.AddControlToHeader(maximizeLabel, 1);
			//header1.AddControlToHeader(closeLabel, 2);
		}
		...
		private void SystemLabel_MouseDown(object sender, MouseEventArgs e)
		{
			if (e.Button == MouseButtons.Left)
			{
				...
				else
				{
					...
					{
						SetLabelColors(formIcon, MouseState.Normal);
		...
		private void MainForm_SizeChanged(object sender, EventArgs e)
		{
			...
			if (_previousWindowState != MinMaxState)
			{
				...
				{
					formIcon.Left = LeftBorderPanel.Width;
					formIcon.Top = TopBorderPanel.Height;
					closeLabel.Left -= RightBorderPanel.Width;
