...
namespace CoinInterchanger.Core.ViewModels
{
	/// <summary>
	/// A base view model that fires Property Changed events as needed.
	/// Works best with PropertyChanged.Fody package which implements property notification to all classes that have <see cref="INotifyPropertyChanged"/>.
	/// </summary>
